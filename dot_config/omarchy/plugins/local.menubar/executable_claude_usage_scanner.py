...
Copie verbatim de scripts/claude_usage_scanner.py du plugin omarchy.model-usage
(Omarchy, MIT). Embarque ici pour que local.menubar ne depende pas de
l'arborescence d'un autre plugin. A resynchroniser depuis
/usr/share/omarchy/shell/plugins/model-usage/scripts/ apres une mise a jour
d'Omarchy.
